...
from . import analyzer_pb2 as analyzer_dot_analyzer__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in analyzer/analyzer_pb2_grpc.py depends on'
...
class AnalyzerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ParseManifest = channel.unary_unary(
                ...
                response_deserializer=analyzer_dot_analyzer__pb2.ParsedManifest.FromString,
...
def add_AnalyzerServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ParseManifest': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=analyzer_dot_analyzer__pb2.ParsedManifest.SerializeToString,
            ),
    }
...
class AnalyzerService(object):
    ...
    def ParseManifest(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/analyzer.AnalyzerService/ParseManifest',
            analyzer_dot_analyzer__pb2.ManifestRequest.SerializeToString,
            analyzer_dot_analyzer__pb2.ParsedManifest.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
